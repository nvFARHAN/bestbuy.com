let footer = () => {
  return `
      ...
      <footer class="py-5">
        <div class="row footer_header pb-5 d-flex justify-content-between">
          <div class="col-2 d-flex flex-column align-items-center">
            ...
            <a class="mt-4" href="#">Visit our Support Center</a>
          </div>
          <div class="col-2 d-flex flex-column align-items-center">
            <svg
              aria-hidden="true"
            ...
            >
              ...
              >
                ...
                ></path>
                <path
                  d="M16 29.53a1 1 0 0 1-1-1V14.17c0-.55.45-1 1-1s1 .45 1 1v14.36a1 1 0 0 1-1 1z"
                ></path>
                <path
            ...
            <a class="mt-4" href="#">Check your Order Status</a>
          </div>
          <div class="col-2 d-flex flex-column align-items-center">
            <svg
              aria-hidden="true"
            ...
            <a class="mt-4" href="#">Shipping, Delivery & Store Pickup</a>
          </div>
          <div class="col-2 d-flex flex-column align-items-center">
            <svg
              aria-hidden="true"
            ...
            >
              ...
              >
                <path
                  d="M13.54 14.45h5.12a.98.98 0 0 0 0-1.95h-5.12a.98.98 0 0 0 0 1.95z"
                ></path>
                <path
            ...
            <a class="mt-4" href="#">Returns & Exchanges</a>
          </div>
          <div class="col-2 d-flex flex-column align-items-center">
            <svg
              aria-hidden="true"
            ...
            <a class="mt-4" href="#">Price Match Guarantee</a>
          </div>
        </div>
        ...
        <div class="row">
          <div class="row col-8">
            <div class="col-4">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted">Gift Cards</a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-4">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Visit our Support Center</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Shop with an Expert</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                ...
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Manage an Appointment</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Protection & Support Plans</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Haul Away & Recycling</a
                  >
                </li>
                <li class="nav-item mb-2">
            ...
            <div class="col-4">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted">Developers</a>
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Best Buy Health</a
            ...
            <div class="col-4">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >My Best Buy® Credit Card</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Pay Your Bill at Citibank</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted">Lease to Own</a>
                </li>
              </ul>
            </div>

            <div class="col-4">
              <h5>Rewards & Membership</h5>
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >Best Buy Totaltech</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted">My Best Buy</a>
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
                    >View Points & Certificates</a
                  >
                </li>
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted">Member Offers</a>
                </li>
              </ul>
            </div>

            <div class="col-4">
              <h5>About Best Buy</h5>
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a href="#" class="nav-link p-0 text-muted"
          ...
          <div class="col-4">
            ...
            <div class="col-12 border-top py-3">
              <form>
                <h5>Get the latest deals and more.</h5>
            ...
            <div class="col-12 border-top py-3">
              <div class="d-flex" aria-label="Learn more about Best Buy App">
                <div class="best-buy-app-icon">
                  <svg
                    aria-hidden="true"
                    role="img"
                    viewBox="0 0 100 100"
                ...
                <div class="d-flex flex-column">
                  <span class="best-buy-app-title">Best Buy app</span
                  ><a
        ...
        <div class="d-flex justify-content-between pt-5">
          <div>
            <p>
              How was your experience?<a href="#">
                Give feedback about our website</a
              >
            </p>
          </div>
        ...
        <div class="d-flex gap-3 footer_end">
        ...
        <div class="d-flex justify-content-between py-2 my-2 footer_end">
          <p>
            In-store pricing may vary. Prices and offers are subject to change.
            &copy; 2022 Best Buy. All rights reserved. BEST BUY, the BEST BUY
            logo, the tag design, and MY BEST BUY are trademarks of Best Buy and
